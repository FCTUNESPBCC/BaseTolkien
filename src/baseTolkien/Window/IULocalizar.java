 ...
 * @author Eloigdn
 */
public class IULocalizar extends javax.swing.JFrame {
   String codigo = null;
    /**
     * Creates new form IULocalizar
     */
    public IULocalizar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        if (localizar_Table.getColumnModel().getColumnCount() > 0) {
            localizar_Table.getColumnModel().getColumn(1).setResizable(false);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IULocalizar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IULocalizar().setVisible(true);
            }
        });
    }
